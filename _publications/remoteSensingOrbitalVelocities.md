---
title: "Remote sensing of wave-orbital velocities in the surfzone"
collection: publications
permalink: /publications/remoteSensingOrbitalVelocities
excerpt: 'This paper demonstrates the ability to estimate subsurface velocity and velocity spectra in the surfzone using surface velocities measured remotely with cameras and particle image velocimetry (PIV)'
date: 2025-01-01
...
Figure: Scatter plot of surface velocity corrected for depth attenuation (y-axis) versus in-situ measured subsurface velocity (x-axis). Circles are binned data (bin width = 0.2 m/s) and errors bars are one standard deviation of the 2 Hz wave-orbital velocities in each bin.

Figure: Power spectral density of the PIV-estimated surface velocities (red), surface velocities depth-corrected to the depth of the in-situ instrument (blue), and the subsurface velocities measured in-situ (black). Shaded region represents the spectral uncertainty if water depth is over- or underestimated by 25%
